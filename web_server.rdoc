...
== Ruby (Enterprise Edition)
  ...
  cd /usr/local/src
  sudo wget http://rubyforge.org/frs/download.php/66162/ruby-enterprise-1.8.7-2009.10.tar.gz
  sudo tar xzvf ruby-enterprise-1.8.7-2009.10.tar.gz
  sudo ruby-enterprise-1.8.7-2009.10/installer

  cd /usr/local/bin
  sudo ln -s /opt/ruby-enterprise-1.8.7-2009.10/bin/ruby
  sudo ln -s /opt/ruby-enterprise-1.8.7-2009.10/bin/gem
  sudo ln -s /opt/ruby-enterprise-1.8.7-2009.10/bin/irb
  sudo ln -s /opt/ruby-enterprise-1.8.7-2009.10/bin/rake
...
Install:
  ...
  sudo /opt/ruby-enterprise-1.8.7-2009.10/bin/passenger-install-apache2-module -a
...
Configure:
  ...
  # add lines:
  LoadModule passenger_module /opt/ruby-enterprise-1.8.7-2009.10/lib/ruby/gems/1.8/gems/passenger-2.2.5/ext/apache2/mod_passenger.so
  PassengerRoot /opt/ruby-enterprise-1.8.7-2009.10/lib/ruby/gems/1.8/gems/passenger-2.2.5
...
== Gems
  ...
  sudo ln -s /opt/ruby-enterprise-1.8.7-2009.10/bin/whenever /usr/local/bin/whenever
...
Edit config (<tt>/etc/postfix/main.cf</tt>):
