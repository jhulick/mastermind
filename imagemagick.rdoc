...
== Manual Compile and Install
  ...
  sudo apt-get install libperl-dev libfontconfig1-dev libpng12-dev libjpeg-dev
  
  cd /usr/local/src
  sudo wget ftp://ftp.fifi.org/pub/ImageMagick/ImageMagick-6.5.9-1.tar.gz
  sudo tar xvfz ImageMagick-6.5.9-1.tar.gz
  cd ImageMagick-6.5.9-1
