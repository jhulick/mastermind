...
=== Development Basics
  ...
  sudo apt-get install build-essential vim-gnome gedit-plugins meld rpl \
    curl subversion git-core imagemagick libxml2-dev libxslt1-dev redis-server
...
=== Ruby
  ...
  sudo apt-get install ruby1.8 ri ruby1.8-dev rdoc irb \
    libmysql-ruby1.8 libmysqlclient15-dev libopenssl-ruby
...
=== Gems, Rails, etc
  ...
  sudo tar -xf rubygems-1.3.6.tgz
  cd rubygems-1.3.6
  sudo ruby setup.rb
