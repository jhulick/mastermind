...
=== Basic
  ...
  sudo apt-get install ubuntu-restricted-extras rar ntp xchm \
    compizconfig-settings-manager inkscape transmission hamster-applet

Then install Skype from .deb package.
...
=== Development Basics
  ...
  sudo apt-get install build-essential vim-full vim-ruby \
